export default function Organization (){
    return (
        ...
        <form className="text-center max-w-sm mx-auto rounded-lg py-4 shadow-md">
            <h5 className="py-5 px-2 text-2xl font-bold ">Organization</h5>
            ...
            <input type="text" placeholder="1-100" required className="py-3 px-5 mb-4 outline-none w-full bg-slate-600 text-white my-2 rounded-md"/> <br />
            <label className="text-left block mb-2">Company WebSite</label>
            <input type="text" placeholder="www.Oragnization.com" required className="py-3 px-5 mb-4 outline-none w-full bg-slate-600 text-white my-2 rounded-md"/> <br />
