...
const Profile = () => {
    ...
    const {newProfile , profile} = useProfile();
    console.log("the profile of the user from profile page: " , profile);
    ...
    //static profile form
    return (
        <form onSubmit={handleSubmit} className="max-w-lg mx-auto p-6  shadow-xl rounded-md mt-8">
